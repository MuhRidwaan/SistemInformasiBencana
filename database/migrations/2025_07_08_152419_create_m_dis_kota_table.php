...
return new class extends Migration
{
    ...
    {
        Schema::create('m_dis_kota', function (Blueprint $table) {
            $table->bigIncrements('kota_id'); // Primary Key
            $table->bigInteger('provinsi_id')->unsigned(); // Foreign Key ke Provinsi
    ...
    {
        Schema::dropIfExists('m_dis_kota');
    }
};

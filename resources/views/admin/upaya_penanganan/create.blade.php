...
@section('title', 'Tambah Upaya Penanganan | Page')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Upaya Penanganan</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <form action="{{ route('upaya-penanganan.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="jenis_upaya" name="jenis_upaya"
                                value="{{ old('jenis_upaya') }}" required>
                            @error('jenis_upaya')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="tanggal_penanganan"
                                name="tanggal_penanganan" value="{{ old('tanggal_penanganan') }}" required>

...
@section('title', 'Edit Kebutuhan Logistik | Page')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Kebutuhan Logistik</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <form action="{{ route('kebutuhan-logistik.update', $kebutuhanLogistik->kebutuhan_id) }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                            ...
                            <select class="form-control" id="bencana_id" name="bencana_id" required>
                                ...
                                @foreach ($bencanaList as $bencana)
                                    <option value="{{ $bencana->bencana_id }}"
                                        {{ old('bencana_id', $kebutuhanLogistik->bencana_id) == $bencana->bencana_id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="jenis_kebutuhan" name="jenis_kebutuhan"
                                value="{{ old('jenis_kebutuhan', $kebutuhanLogistik->jenis_kebutuhan) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jumlah_dibutuhkan" name="jumlah_dibutuhkan"
                                value="{{ old('jumlah_dibutuhkan', $kebutuhanLogistik->jumlah_dibutuhkan) }}" required
                                min="0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="satuan" name="satuan"
                                value="{{ old('satuan', $kebutuhanLogistik->satuan) }}" required>
                            @error('satuan')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jumlah_tersedia" name="jumlah_tersedia"
                                value="{{ old('jumlah_tersedia', $kebutuhanLogistik->jumlah_tersedia) }}" required
                                min="0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="tanggal_update" name="tanggal_update"
                                value="{{ old('tanggal_update', $kebutuhanLogistik->tanggal_update ? $kebutuhanLogistik->tanggal_update->format('Y-m-d\TH:i') : '') }}"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $kebutuhanLogistik->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>

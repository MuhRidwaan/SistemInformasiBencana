...
@section('title', 'Edit Lokasi Posko | Page')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Lokasi Posko</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <form action="{{ route('lokasi-posko.update', $lokasiPosko->posko_id) }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                            ...
                            <select class="form-control" id="bencana_id" name="bencana_id" required>
                                ...
                                @foreach ($bencanaList as $bencana)
                                    <option value="{{ $bencana->bencana_id }}"
                                        {{ old('bencana_id', $lokasiPosko->bencana_id) == $bencana->bencana_id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_posko" name="nama_posko"
                                value="{{ old('nama_posko', $lokasiPosko->nama_posko) }}" required>
                            @error('nama_posko')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="alamat_posko" name="alamat_posko" rows="3" required>{{ old('alamat_posko', $lokasiPosko->alamat_posko) }}</textarea>
                            @error('alamat_posko')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="latitude" name="latitude"
                                        value="{{ old('latitude', $lokasiPosko->latitude) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="longitude" name="longitude"
                                        value="{{ old('longitude', $lokasiPosko->longitude) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="kapasitas" name="kapasitas"
                                value="{{ old('kapasitas', $lokasiPosko->kapasitas) }}" min="0">
                            @error('kapasitas')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kontak_person" name="kontak_person"
                                value="{{ old('kontak_person', $lokasiPosko->kontak_person) }}">
                            @error('kontak_person')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>

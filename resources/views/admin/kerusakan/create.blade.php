...
@section('title', 'Tambah Data Kerusakan | Page')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Data Kerusakan</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tingkat_kerusakan" name="tingkat_kerusakan"
                                value="{{ old('tingkat_kerusakan') }}" placeholder="Contoh: Ringan, Sedang, Berat"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="satuan" name="satuan"
                                value="{{ old('satuan') }}" placeholder="Contoh: Unit, Bangunan, Rumah" required>
                            @error('satuan')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>

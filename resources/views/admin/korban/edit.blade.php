...
@section('title', 'Edit Data Korban | Page')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Data Korban</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <form action="{{ route('korban.update', $korban->korban_id) }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                            ...
                            <select class="form-control" id="bencana_id" name="bencana_id" required>
                                ...
                                @foreach ($bencanaList as $bencana)
                                    <option value="{{ $bencana->bencana_id }}"
                                        {{ old('bencana_id', $korban->bencana_id) == $bencana->bencana_id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="meninggal" name="meninggal"
                                value="{{ old('meninggal', $korban->meninggal) }}" required min="0">
                            @error('meninggal')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="luka_berat" name="luka_berat"
                                value="{{ old('luka_berat', $korban->luka_berat) }}" required min="0">
                            @error('luka_berat')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="luka_ringan" name="luka_ringan"
                                value="{{ old('luka_ringan', $korban->luka_ringan) }}" required min="0">
                            @error('luka_ringan')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="hilang" name="hilang"
                                value="{{ old('hilang', $korban->hilang) }}" required min="0">
                            @error('hilang')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="mengungsi" name="mengungsi"
                                value="{{ old('mengungsi', $korban->mengungsi) }}" required min="0">
                            @error('mengungsi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="terdampak" name="terdampak"
                                value="{{ old('terdampak', $korban->terdampak) }}" required min="0">
                            @error('terdampak')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="tanggal_input" name="tanggal_input"
                                value="{{ old('tanggal_input', $korban->tanggal_input ? $korban->tanggal_input->format('Y-m-d\TH:i') : '') }}"
                                required>
                            @error('tanggal_input')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror

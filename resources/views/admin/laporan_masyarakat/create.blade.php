...
@section('title', 'Tambah Laporan Masyarakat | Page')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Laporan Masyarakat</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="jenis_laporan" name="jenis_laporan"
                                value="{{ old('jenis_laporan') }}" required>
                            @error('jenis_laporan')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="deskripsi_laporan" name="deskripsi_laporan" rows="3" required>{{ old('deskripsi_laporan') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status_laporan" name="status_laporan" required>
                                <option value="Pending" {{ old('status_laporan') == 'Pending' ? 'selected' : '' }}>Pending
                                </option>
                                <option value="Diterima" {{ old('status_laporan') == 'Diterima' ? 'selected' : '' }}>
                                    Diterima</option>
                                <option value="Ditolak" {{ old('status_laporan') == 'Ditolak' ? 'selected' : '' }}>Ditolak
                                </option>
                                <option value="Selesai" {{ old('status_laporan') == 'Selesai' ? 'selected' : '' }}>Selesai
                                </option>
                            </select>
